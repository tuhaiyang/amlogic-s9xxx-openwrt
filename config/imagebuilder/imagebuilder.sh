...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        coreutils-truncate curl dosfstools dumpe2fs e2freefrag e2fsprogs kmod-nft-socket kmod-nft-tproxy \
        ...
        \
        luci-app-amlogic luci-i18n-amlogic-zh-cn luci-app-openclash luci-i18n-passwall-zh-cn luci-app-passwall \
