...
git clone --depth 1 https://github.com/tuhaiyang/luci-app-vlmcsd.git package/luci-app-vlmcsd
git clone --depth 1 https://github.com/tuhaiyang/vlmcsd.git package/vlmcsd
